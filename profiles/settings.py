...
SECRET_KEY = '2o=#i-m0$tm0nt%hh)s=d%vey99t8w3!p3f@!kotm9&jat15s1'
...
INSTALLED_APPS = [
    ...
    'rest_framework.authtoken', #Authentication functionality which comes with the rest framework
    'profiles_api',
]
